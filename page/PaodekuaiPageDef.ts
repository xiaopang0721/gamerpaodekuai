...
module gamepaodekuai.page {
	export class PaodekuaiPageDef extends game.gui.page.PageDef {
		...
		static myinit(str: string) {
			super.myinit(str);
			PaodekuaiClip.init();
			PageDef._pageClassMap[PaodekuaiPageDef.PAGE_PDK] = PaodekuaiPage;
			PageDef._pageClassMap[PaodekuaiPageDef.PAGE_PDK_MAP] = PaodekuaiMapPage;
			PageDef._pageClassMap[PaodekuaiPageDef.PAGE_PDK_RULE] = PaodekuaiRulePage;
			PageDef._pageClassMap[PaodekuaiPageDef.PAGE_PDK_CREATE_CARDROOM] = PaodekuaiCreadRoomPage;
			PageDef._pageClassMap[PaodekuaiPageDef.PAGE_PDK_JOIN_CARDROOM] = PaodekuaiJoinRoomPage;
			PageDef._pageClassMap[PaodekuaiPageDef.PAGE_PDK_CARDROOM_SETTLE] = PaodekuaiRoomSettlePage;
