...
module ui.game_ui.paodekuai.component {
    export class BaoDanUI extends View {
        ...
        createChildren():void {
            ...
            this.createView(ui.game_ui.paodekuai.component.BaoDanUI.uiView);
        }
    }
}
...
module ui.game_ui.paodekuai.component {
    export class boomUI extends View {
        ...
        createChildren():void {
            ...
            super.createChildren();
            this.createView(ui.game_ui.paodekuai.component.boomUI.uiView);
        }
    }
}
...
module ui.game_ui.paodekuai.component {
    export class feijiUI extends View {
        ...
        createChildren():void {
            ...
            super.createChildren();
            this.createView(ui.game_ui.paodekuai.component.feijiUI.uiView);
        }
    }
}
...
module ui.game_ui.paodekuai.component {
    export class menuUI extends View {
        ...
        createChildren():void {
            ...
            super.createChildren();
            this.createView(ui.game_ui.paodekuai.component.menuUI.uiView);
        }
    }
}
...
module ui.game_ui.paodekuai.component {
    export class shunziUI extends View {
        ...
        createChildren():void {
            ...
            super.createChildren();
            this.createView(ui.game_ui.paodekuai.component.shunziUI.uiView);
        }
    }
}
...
module ui.game_ui.paodekuai.component {
    export class TouXiangUI extends View {
        ...
        createChildren():void {
            ...
            super.createChildren();
            this.createView(ui.game_ui.paodekuai.component.TouXiangUI.uiView);
        }
    }
}

module ui.game_ui.paodekuai {
    export class FangKa_ChuangJianUI extends View {
        ...
        createChildren():void {
            ...
            super.createChildren();
            this.createView(ui.game_ui.paodekuai.FangKa_ChuangJianUI.uiView);
        }
    }
}
...
module ui.game_ui.paodekuai {
    export class PaoDeKuaiUI extends View {
		...
		public box_player0:Laya.Box;
		public view_player0:ui.game_ui.paodekuai.component.TouXiangUI;
		public img_first0:Laya.Image;
		public img_quanguan0:Laya.Image;
		public text_round:Laya.Label;
		public box_player1:Laya.Box;
		public view_player1:ui.game_ui.paodekuai.component.TouXiangUI;
		...
		public view_baodan1:ui.game_ui.paodekuai.component.BaoDanUI;
		public box_player2:Laya.Box;
		public view_player2:ui.game_ui.paodekuai.component.TouXiangUI;
		...
		public view_baodan2:ui.game_ui.paodekuai.component.BaoDanUI;
		public box_player3:Laya.Box;
		public view_player3:ui.game_ui.paodekuai.component.TouXiangUI;
		...
		public view_baodan3:ui.game_ui.paodekuai.component.BaoDanUI;
		public view_cardroom:ui.game_ui.tongyong.FangKa_GoUI;
		...
		public view_time:ui.game_ui.tongyong.DaoJiShiUI;
        ...
        createChildren():void {
            ...
            super.createChildren();
            this.createView(ui.game_ui.paodekuai.PaoDeKuaiUI.uiView);
        }
    }
}
...
module ui.game_ui.paodekuai {
    export class PaoDeKuai_GuiZeUI extends View {
        ...
        createChildren():void {
            ...
            super.createChildren();
            this.createView(ui.game_ui.paodekuai.PaoDeKuai_GuiZeUI.uiView);
        }
    }
}
